...
|---|---:|---:|---|---|
| SuggestionManagerViewModel.swift | 100.00 | 100.00 | yes | PASS |
...
- FAIL: 0
- BLOCKED: 0
- Coverage: `SuggestionManagerViewModel.swift 100.00% (31/31)`

## ケース結果（最新）
| Case ID | 対象 | 期待値 | 実結果 | 判定 | 証跡 |
|---|---|---|---|---|---|
| VIEWMODEL-001 | SuggestionManagerViewModelTests | query更新、削除表示切替、undo動作の仕様を満たす | 7/7 pass | PASS | `EpisodeStocker/EpisodeStockerTests/ViewModels/SuggestionManagerViewModelTests.swift` |
...
| Case ID | 対象 | 期待値 | 実結果 | 判定 | 証跡 |
|---|---|---|---|---|---|
| VIEWMODEL-001 | SuggestionManagerViewModelTests | query更新、削除表示切替、undo動作の仕様を満たす | 4/4 pass | PASS | `EpisodeStocker/EpisodeStockerTests/ViewModels/SuggestionManagerViewModelTests.swift` |
